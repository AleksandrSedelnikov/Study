#RELEASE 2.0 (количество строчек: 137)

# Изменения в коде по сравнению с release 1.0:
# 1)Весь функционал переехал в отдельную функцию "script"
# 2)Добавлены счётчики ошибок: 01,02,03,04,wrong usl
# 3)Скрипт можно выполнять сколько угодно, пока ответ на вопрос продолжения выполнения будет: "y"
# 4)Согласно пункту 2. был добавлен вывод общего количества ошибок при выполнении скрипта и отдельный вывод количества определенной ошибки
# 5)Согласно пункту 2. была добавлена новая ошибка: wrong usl, она выводится тогда, когда условие продолжения скрипта отличается от "y" и "n"
# 6)Добавлен счётчик решений пользователя добавить пустую строчку в файл: executed
# 7)Согласно пункту 6. был добавлен вывод количества решений пользователя добавлять пустую строчку в файл

...
int main()
{
	...
	cout << "\t\t\t**************************************************************" << endl;
	cout << "\t\t\t***Добро пожаловать в консоль выполнения РГЗ по информатике***" << endl;
	cout << "\t\t\t**************************************************************" << endl;
	cout << "\t\t***Выполнил студент Института Телекоммуникаций, группы АП-103 Седельников А.С.***" << endl;
	cout << "\t\t\t\t\t\t***Вариант 14***" << endl;
	cout << "\t   В данной программе вы можете реализовать формирование массива 3-мя способами, а именно:     \n\t    (1) - датчик рандомных чисел\n\t    (2) - ввод с клавиатуры\n\t    (3) - ввод из файла" << endl;

...
while [ $logout -eq 1 ]
do
    trap 'echo -en "" "\n\033[01;91mВы не можете приостановить процесс tbash.\033[00;0m\n\033[01;97mПродолжите ввод:\033[00;0m "' SIGTSTP
    ...
    then
        clear
        echo -e " \n\033[01;91mДоступ закрыт.\033[00;0m\n\033[01;97mПричина: количество попыток авторизации превышено.\033[00;0m"
        logout=0
        break
    fi
    if [ $countlog -eq 0 ]
    then
        echo -e "\033[01;35mПриветствую в тестовом bash, для авторизации Вам необходимо ввести логин и пароль.\033[00;0m\nЧтобы выйти из авторизации введите \033[01;93mlogout\033[00;0m.\n" ""
    fi
    countlog=`expr $countlog + 1`
    echo -ne "\033[01;97mВведите логин:\033[00;0m "; read login
    if [ $login == "logout" 2>~/error ]
    then
        logout=0
        break
    fi
    echo -ne "\033[01;97mВведите пароль:\033[00;0m "; read password
    ...
    then
        ...
        do
            ...
            then
                echo -e "\033[01;97mВ данный момент доступны следующие команды:\033[00;0m\n1)\033[01;93mlogout\033[00;0m - \033[01;97mвыйти из тестового bash в меню авторизации\033[00;0m\n2)\033[01;93mprint\033[00;0m - \033[01;97mвывести на экран написанное сообщение\033[00;0m\n3)\033[01;93m!date\033[00;0m - \033[01;97mузнать дату\033[00;0m\n4)\033[01;93m!ver\033[00;0m - \033[01;97mверсия tbash\033[00;0m\n5)\033[01;93m!curdir\033[00;0m - \033[01;97mузнать текущую директорию\033[00;0m\n6)\033[01;93m!create [filename] без расширения\033[00;0m - \033[01;97mсоздать файл с выбранным названием\033[00;0m\n7)\033[01;93m!delete [filename] без расширения\033[00;0m - \033[01;97mудалить файл с выбранным названием\033[00;0m\n8)\033[01;93m!dir\033[00;0m - \033[01;97mвывести содержимое текущей директории\033[00;0m\n9)\033[01;93m!clear\033[00;0m - \033[01;97mочистить консоль tbash\033[00;0m\n10)\033[01;93m!calc\033[00;0m - \033[01;97mвойти в калькулятор\033[00;0m\n11)\033[01;93m!news\033[00;0m - \033[01;97mновости tbash\033[00;0m\n" ""
            fi
            ...
            if [ "$command" == "!news" 2>~/error ] # команда !news - новости разработки tbash
            then
                echo -e "\033[01;97mНовости разработки tbash от\033[00;0m \033[01;93m12.12.2022\033[00;0m.\n\033[01;97m[Нововведения]\033[00;0m\n\033[01;93m[1]\033[00;0m \033[01;97mДобавлено логирование введённых команд пользователями\033[00;0m\n\033[01;93m[2]\033[00;0m \033[01;97mЕщё некоторое количество диалогов получили единый цветовой стиль\033[00;0m\n\n\033[01;97m[В разработке]\033[00;0m\n\033[01;93m[1]\033[00;0m \033[01;97mИерархия прав в tbash\033[00;0m\n\033[01;93m[2]\033[00;0m \033[01;97mФормирование некоторых команд в формате отдельных исполняемых файлов (скриптов)\033[00;0m\n" # \n\033[01;93m[2]\033[00;0m \033[01;97mКоманда\033[00;0m \033[01;93m!bashver\033[00;0m \033[01;97mтеперь\033[00;0m \033[01;93m!ver\033[00;0m\n\033[01;93m[3]\033[00;0m \033[01;97mДобавлена новая команда\033[00;0m \033[01;93m!calc\033[00;0m\033[01;97m, а с ней функционал калькулятора tbash\n\n\033[01;97m[В разработке]\033[00;0m\n\033[01;93m[1]\033[00;0m \033[01;97mИерархия прав в tbash\033[00;0m\n\033[01;93m[2]\033[00;0m \033[01;97mФормирование некоторых команд в формате отдельных исполняемых файлов (скриптов)\033[00;0m\n"
            fi
            ...
            then
                ...
                do
                    ...
                    then
                        ...
                        let pow=$value**$step
                        echo -e  "\033[01;92mОтвет:\033[00;0m $pow"
                    fi
                    ...
                    then
                        ...
                        echo -e "\033[01;92mОтвет:\033[00;0m $sqrt"
                    fi
            ...
            then
                echo -e "\033[01;97mВерсия tbash\033[00;0m - \033[01;93m0.1.6\033[00;0m \033[01;37m(от 09.12.2022)\033[00;0m\n\033[01;97mDebug\033[00;0m - \033[01;90m016]183[tyfhi2\033[00;0m"
            fi
            ...
            then
                ...
                then
                    ...
                    then
                        ...
                        echo -e "\033[01;97m$text\033[00;0m"
                    fi
                fi
            fi
